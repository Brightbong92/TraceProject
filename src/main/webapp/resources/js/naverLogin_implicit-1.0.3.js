 ...
 */
	...
	this.init_naver_id_login = function ()
	{
		...
		else if (this.button_type == BANNER_SMALL_TYPE)
		{
			...
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='/resources/images/naver_button.png' border='0' title='네이버 로그인'></a> ";
		}
		else 
		{
