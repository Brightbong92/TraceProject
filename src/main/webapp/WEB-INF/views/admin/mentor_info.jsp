...
<body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${list.ml_apply eq 1}">
                                        	<td><button onclick="javascript:location.href='../admin/mentor_approved.do?mem_email=${list.mem_email}'" mem_email="${list.mem_email}" class="btn btn-success" id="mentorAccept">멘토 승인</button>
	...
	$(document).ready(function() {
		...
		$('#mentorAccept').on('click', function(){
			if (socket.readyState !== 1) return;
			var mem_email = $(this).attr('mem_email');
			socket.send("mentorAccept,"+mem_email);
		});
