                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form name="input" method="post" action="../admin/notice_write.do">
                                    	<input type='hidden' name='mem_email' value='admin'>
                                        <div class="form-group">
                                        	&nbsp;
                                            <label>제목</label>
                                            <input class="form-control" name="noti_subject" style="width:1100px;">
                                        </div>
                                       
                                        <div class="form-group">
                                        	&nbsp;
                                            <label>공지내용</label>
                                            <textarea class="form-control" rows="3" name="noti_content" style="width:1100px; height:300px;"></textarea>
                                        </div>
