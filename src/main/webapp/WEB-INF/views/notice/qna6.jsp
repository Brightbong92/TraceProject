...
<div id="board_area">
	...
	<div class="board_view_top">
				<p class="tit" style="font-size: 20px;">호스트는 어떻게 신청하나요?</p>
				<ul class="info" style="font-size: 15px;">
				<li>작성자 : 관리자</li>
				<li>작성일 : 2019-12-24</li>
				</ul>
				<p class="cl" align="right">조회수 :81</p>
	</div>
	<div class="board_view_middle" style="font-size: 15px;">
		<p style="font-size:15px;">홈페이지 상단에 들어가셔서 [호스트 가입]을 클릭하신 다음에 가입을 해주시면 됩니다.</p>
	</div>
</div>
