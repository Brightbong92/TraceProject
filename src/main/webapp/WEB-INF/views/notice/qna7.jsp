...
<div id="board_area">
	...
	<div class="board_view_top">
				<p class="tit" style="font-size: 20px;">날씨 때문에 취소되면 어떻게 하나요?</p>
				<ul class="info" style="font-size: 15px;">
				<li>작성자 : 관리자</li>
				<li>작성일 : 2019-12-19</li>
				</ul>
				<p class="cl" align="right">조회수 :120</p>
	</div>
	<div class="board_view_middle" style="font-size: 15px;">
		<p style="font-size:15px;">기상 악화, 인원 미달, 호스트 개인 사정으로 인한 취소는 카카오톡 또는 문자로 안내 드리고 있습니다.</p>
	</div>
</div>
