...
<div id="board_area">
	...
	<div class="board_view_top">
				<p class="tit" style="font-size: 20px;">쿠폰을 등록했습니다. 어떻게 사용하나요?</p>
				<ul class="info" style="font-size: 15px;">
				<li>작성자 : 관리자</li>
				<li>작성일 : 2020-01-02</li>
				</ul>
				<p class="cl" align="right">조회수 :52</p>
	</div>
	<div class="board_view_middle" style="font-size: 15px;">
		<p style="font-size:15px;">쿠폰 등록 시 마일리지로 충전되며, 충전한 마일리지는 현금처럼(1p=1원) 사용이 가능합니다. </p>
	</div>
</div>
