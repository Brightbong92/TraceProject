...
<div id="board_area">
	...
	<div class="board_view_top">
				<p class="tit" style="font-size: 20px;">결제수단 종류는 어떤 것들이 있나요?</p>
				<ul class="info" style="font-size: 15px;">
				<li>작성자 : 관리자</li>
				<li>작성일 : 2020-01-17</li>
				</ul>
				<p class="cl" align="right">조회수 :34</p>
	</div>
	<div class="board_view_middle" style="font-size: 15px;">
		<p style="font-size:15px;">결제 수단은 ‘마이페이지>정기구독 관리>결제수단 정보 변경’에서 변경하실 수 있습니다.</p>
	</div>
</div>
