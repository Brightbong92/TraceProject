...
<script type="text/javascript" src="https://service.iamport.kr/js/iamport.payment-1.1.5.js"></script>
  ...
  <div class="container">
    ...
    <form name="f" method="post" action="../payment/purchaseInfo.do">
		...
		<hr>
			<div>
				<span>나의 포인트: </span><span id="mem_point" point="${listResult.points}">${listResult.points}</span>P&nbsp;&nbsp;&nbsp;
		...
		<hr>
			<div>
				<span id="pi_price">${listResult.mtr_price * listResult.mtrdi_list.size()}</span>원
