  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox" style="width:58%; height:400px; margin-left:21%" >
        ...
        <div class="carousel-item active" style="background-image: url('../index_images/메인1.jpeg')">
          <div class="carousel-caption d-none d-md-block">
          </div>
        </div>
        <!-- Slide Two - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('../index_images/메인2.png')">
          <div class="carousel-caption d-none d-md-block">
          </div>
        </div>
        <!-- Slide Three - Set the background image for this slide in the line below -->
        <div class="carousel-item" style="background-image: url('../index_images/메인3.jpeg')">
          <div class="carousel-caption d-none d-md-block">
          </div>
        </div>
      </div>
